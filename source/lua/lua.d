...
extern(C) int lua_resetthread(lua_State* L);
...
extern(C) byte* lua_typename(lua_State* L, int tp);
...
extern(C) byte* lua_tolstring(lua_State* L, int idx, size_t* len);
extern(C) lua_Unsigned lua_rawlen(lua_State* L, int idx);
...
extern(C) byte* lua_pushlstring(lua_State* L, byte* s, size_t len);
extern(C) byte* lua_pushstring(lua_State* L, byte* s);
extern(C) byte* lua_pushvfstring(lua_State* L, byte* fmt, va_list argp);
extern(C) byte* lua_pushfstring(lua_State* L, byte* fmt);
...
extern(C) int lua_getglobal(lua_State* L, byte* name);
extern(C) int lua_gettable(lua_State* L, int idx);
extern(C) int lua_getfield(lua_State* L, int idx, byte* k);
...
extern(C) int lua_rawgetp(lua_State* L, int idx, void* p);
extern(C) void lua_createtable(lua_State* L, int narr, int nrec);
extern(C) void* lua_newuserdatauv(lua_State* L, size_t sz, int nuvalue);
extern(C) int lua_getmetatable(lua_State* L, int objindex);
extern(C) int lua_getiuservalue(lua_State* L, int idx, int n);
extern(C) void lua_setglobal(lua_State* L, byte* name);
extern(C) void lua_settable(lua_State* L, int idx);
extern(C) void lua_setfield(lua_State* L, int idx, byte* k);
...
extern(C) void lua_rawsetp(lua_State* L, int idx, void* p);
extern(C) int lua_setmetatable(lua_State* L, int objindex);
extern(C) int lua_setiuservalue(lua_State* L, int idx, int n);
...
extern(C) int lua_load(lua_State* L, lua_Reader reader, void* dt, byte* chunkname, byte* mode);
...
extern(C) int lua_resume(lua_State* L, lua_State* from, int narg, int* nres);
extern(C) int lua_status(lua_State* L);
extern(C) int lua_isyieldable(lua_State* L);
extern(C) void lua_setwarnf(lua_State* L, lua_WarnFunction f, void* ud);
extern(C) void lua_warning(lua_State* L, byte* msg, int tocont);
extern(C) int lua_gc(lua_State* L, int what);
...
extern(C) int lua_getinfo(lua_State* L, byte* what, lua_Debug* ar);
extern(C) byte* lua_getlocal(lua_State* L, lua_Debug* ar, int n);
extern(C) byte* lua_setlocal(lua_State* L, lua_Debug* ar, int n);
extern(C) byte* lua_getupvalue(lua_State* L, int funcindex, int n);
extern(C) byte* lua_setupvalue(lua_State* L, int funcindex, int n);
...
extern(C) int lua_setcstacklimit(lua_State* L, uint limit);
