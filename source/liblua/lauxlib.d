...
extern(C) const(char)* luaL_checklstring(lua_State* L, int arg, size_t* l);
extern(C) const(char)* luaL_optlstring(lua_State* L, int arg, const(char)* def, size_t* l);
...
extern(C) const(char)* luaL_tolstring(lua_State* L, int idx, size_t* len);
