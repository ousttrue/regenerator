...
alias CXCursorVisitor = extern(C) CXChildVisitResult function(CXCursor cursor, CXCursor parent, void* client_data);
...
alias CXInclusionVisitor = extern(C) void function(void* included_file, CXSourceLocation* inclusion_stack, uint include_len, void* client_data);
...
{
    void* context;
    extern(C) CXVisitorResult function(void* context, CXCursor , CXSourceRange ) visit;
}
enum CXResult
{
    _Success = 0x0,
...
{
    extern(C) int function(void* client_data, void* reserved) abortQuery;
    extern(C) void function(void* client_data, void* , void* reserved) diagnostic;
    extern(C) void* function(void* client_data, void* mainFile, void* reserved) enteredMainFile;
    extern(C) void* function(void* client_data, const(CXIdxIncludedFileInfo)* ) ppIncludedFile;
    extern(C) void* function(void* client_data, const(CXIdxImportedASTFileInfo)* ) importedASTFile;
    extern(C) void* function(void* client_data, void* reserved) startedTranslationUnit;
    extern(C) void function(void* client_data, const(CXIdxDeclInfo)* ) indexDeclaration;
    extern(C) void function(void* client_data, const(CXIdxEntityRefInfo)* ) indexEntityReference;
}
...
alias CXFieldVisitor = extern(C) CXVisitorResult function(CXCursor C, void* client_data);
...
extern(C) CXString clang_Cursor_getMangling(CXCursor __param__1);
...
extern(C) uint clang_isCursorDefinition(CXCursor __param__1);
extern(C) CXCursor clang_getCursorDefinition(CXCursor __param__1);
extern(C) CXString clang_Cursor_getObjCPropertyGetterName(CXCursor C);
extern(C) CXCursor clang_getCanonicalCursor(CXCursor __param__1);
extern(C) int clang_Cursor_isDynamicCall(CXCursor C);
extern(C) int clang_Cursor_getObjCSelectorIndex(CXCursor __param__1);
extern(C) CXType clang_Cursor_getReceiverType(CXCursor C);
extern(C) CXCursor clang_getCursorReferenced(CXCursor __param__1);
extern(C) CXStringSet* clang_Cursor_getCXXManglings(CXCursor __param__1);
...
extern(C) CXStringSet* clang_Cursor_getObjCManglings(CXCursor __param__1);
extern(C) uint clang_CXXConstructor_isConvertingConstructor(CXCursor C);
extern(C) uint clang_Module_getNumTopLevelHeaders(CXTranslationUnitImpl* __param__1, void* Module);
extern(C) void* clang_Module_getASTFile(void* Module);
extern(C) void* clang_getModuleForFile(CXTranslationUnitImpl* __param__1, void* __param__2);
extern(C) void* clang_Module_getTopLevelHeader(CXTranslationUnitImpl* __param__1, void* Module, uint Index);
...
extern(C) CXString clang_getCursorDisplayName(CXCursor __param__1);
...
extern(C) uint clang_isVirtualBase(CXCursor __param__1);
extern(C) CX_StorageClass clang_Cursor_getStorageClass(CXCursor __param__1);
extern(C) CXString clang_getCursorSpelling(CXCursor __param__1);
...
extern(C) CXSourceRange clang_Cursor_getSpellingNameRange(CXCursor __param__1, uint pieceIndex, uint options);
...
extern(C) void* clang_getCursorPrintingPolicy(CXCursor __param__1);
extern(C) CX_CXXAccessSpecifier clang_getCXXAccessSpecifier(CXCursor __param__1);
...
extern(C) CXType clang_getIBOutletCollectionType(CXCursor __param__1);
extern(C) CXString clang_getCursorUSR(CXCursor __param__1);
extern(C) uint clang_visitChildren(CXCursor parent, CXCursorVisitor visitor, void* client_data);
...
extern(C) void* clang_getRemappings(const(char)* path);
extern(C) void clang_EvalResult_dispose(void* E);
extern(C) const(char)* clang_EvalResult_getAsStr(void* E);
extern(C) void* clang_getRemappingsFromFileList(const(char)** filePaths, uint numFiles);
extern(C) void clang_remap_getFilenames(void* __param__1, uint index, CXString* original, CXString* transformed);
extern(C) uint clang_remap_getNumFiles(void* __param__1);
extern(C) void clang_remap_dispose(void* __param__1);
...
extern(C) void clang_getInclusions(CXTranslationUnitImpl* tu, CXInclusionVisitor visitor, void* client_data);
...
extern(C) const(CXIdxObjCContainerDeclInfo)* clang_index_getObjCContainerDeclInfo(const(CXIdxDeclInfo)* __param__1);
extern(C) void clang_IndexAction_dispose(void* __param__1);
extern(C) void* clang_IndexAction_create(void* CIdx);
extern(C) void clang_index_setClientEntity(const(CXIdxEntityInfo)* __param__1, void* __param__2);
extern(C) int clang_indexSourceFile(void* __param__1, void* client_data, IndexerCallbacks* index_callbacks, uint index_callbacks_size, uint index_options, const(char)* source_filename, const(const(char)*)* command_line_args, int num_command_line_args, CXUnsavedFile* unsaved_files, uint num_unsaved_files, CXTranslationUnitImpl** out_TU, uint TU_options);
extern(C) int clang_indexTranslationUnit(void* __param__1, void* client_data, IndexerCallbacks* index_callbacks, uint index_callbacks_size, uint index_options, CXTranslationUnitImpl* __param__6);
extern(C) int clang_indexSourceFileFullArgv(void* __param__1, void* client_data, IndexerCallbacks* index_callbacks, uint index_callbacks_size, uint index_options, const(char)* source_filename, const(const(char)*)* command_line_args, int num_command_line_args, CXUnsavedFile* unsaved_files, uint num_unsaved_files, CXTranslationUnitImpl** out_TU, uint TU_options);
extern(C) void clang_indexLoc_getFileLocation(CXIdxLoc loc, void** indexFile, void** file, uint* line, uint* column, uint* offset);
extern(C) int clang_index_isEntityObjCContainerKind(CXIdxEntityKind __param__1);
extern(C) void* clang_index_getClientEntity(const(CXIdxEntityInfo)* __param__1);
extern(C) void* clang_index_getClientContainer(const(CXIdxContainerInfo)* __param__1);
extern(C) const(CXIdxObjCCategoryDeclInfo)* clang_index_getObjCCategoryDeclInfo(const(CXIdxDeclInfo)* __param__1);
extern(C) const(CXIdxObjCInterfaceDeclInfo)* clang_index_getObjCInterfaceDeclInfo(const(CXIdxDeclInfo)* __param__1);
extern(C) void clang_index_setClientContainer(const(CXIdxContainerInfo)* __param__1, void* __param__2);
extern(C) const(CXIdxObjCProtocolRefListInfo)* clang_index_getObjCProtocolRefListInfo(const(CXIdxDeclInfo)* __param__1);
extern(C) const(CXIdxIBOutletCollectionAttrInfo)* clang_index_getIBOutletCollectionAttrInfo(const(CXIdxAttrInfo)* __param__1);
extern(C) const(CXIdxObjCPropertyDeclInfo)* clang_index_getObjCPropertyDeclInfo(const(CXIdxDeclInfo)* __param__1);
extern(C) const(CXIdxCXXClassDeclInfo)* clang_index_getCXXClassDeclInfo(const(CXIdxDeclInfo)* __param__1);
...
extern(C) void clang_getDefinitionSpellingAndExtent(CXCursor __param__1, const(char)** startBuf, const(char)** endBuf, uint* startLine, uint* startColumn, uint* endLine, uint* endColumn);
extern(C) void clang_executeOnThread(void function(void* ) fn, void* user_data, uint stack_size);
...
extern(C) CXSourceLocation clang_getTokenLocation(CXTranslationUnitImpl* __param__1, CXToken __param__2);
...
extern(C) CXSourceRange clang_getTokenExtent(CXTranslationUnitImpl* __param__1, CXToken __param__2);
extern(C) CXSourceRange clang_getCursorReferenceNameRange(CXCursor C, uint NameFlags, uint PieceIndex);
extern(C) CXTokenKind clang_getTokenKind(CXToken __param__1);
extern(C) CXToken* clang_getToken(CXTranslationUnitImpl* TU, CXSourceLocation Location);
extern(C) CXString clang_getTokenSpelling(CXTranslationUnitImpl* __param__1, CXToken __param__2);
...
extern(C) CXCodeCompleteResults* clang_codeCompleteAt(CXTranslationUnitImpl* TU, const(char)* complete_filename, uint complete_line, uint complete_column, CXUnsavedFile* unsaved_files, uint num_unsaved_files, uint options);
...
extern(C) uint clang_getDiagnosticNumRanges(void* __param__1);
extern(C) CXString clang_getDiagnosticCategoryText(void* __param__1);
...
extern(C) CXTranslationUnitImpl* clang_createTranslationUnitFromSourceFile(void* CIdx, const(char)* source_filename, int num_clang_command_line_args, const(const(char)*)* clang_command_line_args, uint num_unsaved_files, CXUnsavedFile* unsaved_files);
extern(C) uint clang_getDiagnosticCategory(void* __param__1);
extern(C) CXString clang_getDiagnosticSpelling(void* __param__1);
...
extern(C) CXDiagnosticSeverity clang_getDiagnosticSeverity(void* __param__1);
extern(C) uint clang_defaultDiagnosticDisplayOptions();
extern(C) CXSourceLocation clang_getDiagnosticLocation(void* __param__1);
extern(C) void* clang_getDiagnostic(CXTranslationUnitImpl* Unit, uint Index);
extern(C) CXTranslationUnitImpl* clang_createTranslationUnit(void* CIdx, const(char)* ast_filename);
...
extern(C) CXErrorCode clang_createTranslationUnit2(void* CIdx, const(char)* ast_filename, CXTranslationUnitImpl** out_TU);
...
extern(C) void clang_disposeTranslationUnit(CXTranslationUnitImpl* __param__1);
extern(C) CXErrorCode clang_parseTranslationUnit2(void* CIdx, const(char)* source_filename, const(const(char)*)* command_line_args, int num_command_line_args, CXUnsavedFile* unsaved_files, uint num_unsaved_files, uint options, CXTranslationUnitImpl** out_TU);
extern(C) CXTranslationUnitImpl* clang_parseTranslationUnit(void* CIdx, const(char)* source_filename, const(const(char)*)* command_line_args, int num_command_line_args, CXUnsavedFile* unsaved_files, uint num_unsaved_files, uint options);
extern(C) uint clang_defaultReparseOptions(CXTranslationUnitImpl* TU);
extern(C) CXErrorCode clang_parseTranslationUnit2FullArgv(void* CIdx, const(char)* source_filename, const(const(char)*)* command_line_args, int num_command_line_args, CXUnsavedFile* unsaved_files, uint num_unsaved_files, uint options, CXTranslationUnitImpl** out_TU);
extern(C) int clang_saveTranslationUnit(CXTranslationUnitImpl* TU, const(char)* FileName, uint options);
extern(C) uint clang_defaultSaveOptions(CXTranslationUnitImpl* TU);
extern(C) uint clang_suspendTranslationUnit(CXTranslationUnitImpl* __param__1);
...
extern(C) const(char)* clang_getFileContents(CXTranslationUnitImpl* tu, void* file, ulong* size);
...
extern(C) void* clang_getFile(CXTranslationUnitImpl* tu, const(char)* file_name);
extern(C) int clang_getFileUniqueID(void* file, CXFileUniqueID* outID);
extern(C) void clang_CXIndex_setGlobalOptions(void* __param__1, uint options);
...
extern(C) uint clang_CXIndex_getGlobalOptions(void* __param__1);
extern(C) CXString clang_getFileName(void* SFile);
extern(C) void clang_CXIndex_setInvocationEmissionPathOption(void* __param__1, const(char)* Path);
...
extern(C) void* clang_loadDiagnostics(const(char)* file, CXLoadDiag_Error* error, CXString* errorString);
...
extern(C) CXCursor clang_getTranslationUnitCursor(CXTranslationUnitImpl* __param__1);
...
extern(C) uint clang_equalCursors(CXCursor __param__1, CXCursor __param__2);
extern(C) long clang_getEnumConstantDeclValue(CXCursor C);
extern(C) CXType clang_getTypedefDeclUnderlyingType(CXCursor C);
extern(C) uint clang_isPreprocessing(CXCursorKind __param__1);
extern(C) uint clang_isTranslationUnit(CXCursorKind __param__1);
extern(C) uint clang_isInvalid(CXCursorKind __param__1);
extern(C) uint clang_isUnexposed(CXCursorKind __param__1);
...
extern(C) uint clang_isStatement(CXCursorKind __param__1);
extern(C) CXCursorKind clang_getCursorKind(CXCursor __param__1);
extern(C) uint clang_hashCursor(CXCursor __param__1);
extern(C) uint clang_isAttribute(CXCursorKind __param__1);
extern(C) uint clang_isDeclaration(CXCursorKind __param__1);
extern(C) uint clang_isReference(CXCursorKind __param__1);
extern(C) uint clang_isInvalidDeclaration(CXCursor __param__1);
extern(C) uint clang_isExpression(CXCursorKind __param__1);
...
extern(C) CXCursor clang_getCursor(CXTranslationUnitImpl* __param__1, CXSourceLocation __param__2);
extern(C) void* clang_getIncludedFile(CXCursor cursor);
extern(C) void clang_disposeOverriddenCursors(CXCursor* overridden);
extern(C) CXSourceLocation clang_getCursorLocation(CXCursor __param__1);
extern(C) CXType clang_getCursorType(CXCursor C);
extern(C) CXSourceRange clang_getCursorExtent(CXCursor __param__1);
...
extern(C) CXTranslationUnitImpl* clang_Cursor_getTranslationUnit(CXCursor __param__1);
...
extern(C) uint clang_Type_visitFields(CXType T, CXFieldVisitor visitor, void* client_data);
