...
extern(C) void clang_index_setClientEntity(const(CXIdxEntityInfo)* , void* );
...
extern(C) void* clang_index_getClientEntity(const(CXIdxEntityInfo)* );
extern(C) void* clang_index_getClientContainer(const(CXIdxContainerInfo)* );
...
extern(C) void clang_index_setClientContainer(const(CXIdxContainerInfo)* , void* );
...
extern(C) void clang_CXIndex_setInvocationEmissionPathOption(void* , const(char)* Path);
