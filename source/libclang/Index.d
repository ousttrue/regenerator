...
alias CXCursorVisitor = extern(C) CXChildVisitResult function(CXCursor cursor, CXCursor parent, CXClientData client_data);
...
alias CXInclusionVisitor = extern(C) void function(CXFile included_file, CXSourceLocation* inclusion_stack, uint include_len, CXClientData client_data);
...
{
    extern(C) void function(CXClientData client_data, void* reserved) abortQuery;
    extern(C) void function(CXClientData client_data, CXDiagnosticSet , void* reserved) diagnostic;
    extern(C) CXIdxClientFile function(CXClientData client_data, CXFile mainFile, void* reserved) enteredMainFile;
    extern(C) CXIdxClientFile function(CXClientData client_data, const(CXIdxIncludedFileInfo)* ) ppIncludedFile;
    extern(C) CXIdxClientASTFile function(CXClientData client_data, const(CXIdxImportedASTFileInfo)* ) importedASTFile;
    extern(C) CXIdxClientContainer function(CXClientData client_data, void* reserved) startedTranslationUnit;
    extern(C) void function(CXClientData client_data, const(CXIdxDeclInfo)* ) indexDeclaration;
    extern(C) void function(CXClientData client_data, const(CXIdxEntityRefInfo)* ) indexEntityReference;
}
...
alias CXFieldVisitor = extern(C) CXVisitorResult function(CXCursor C, CXClientData client_data);
